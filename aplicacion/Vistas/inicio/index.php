<?php
    ...
    if (!defined('BASE_URL')) {
        define('BASE_URL', 'http://localhost/uniemprende/'); // Ajusta según tu configuración
    }
...
<style>
    ...
    * {
    ...
    .hero {
        ...
        /* 1. IMAGEN DE FONDO */
        /* Asegúrate de que tu imagen esté en esta ruta o actualiza el nombre del archivo */
        background-image: url('../../assets/images/uniemprende-background.jpg');
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
    }
    ...
    .hero::before {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(145, 2, 2, 0.9) 0%, rgba(80, 0, 0, 0.85) 100%);
        z-index: 1;
    }
    ...
    /* Mejora el contraste del texto con una sombra suave */
    .hero-text h1,
    .hero-text p {
    ...
    .hero-stats {
        ...
        gap: 1.5rem;
        margin-top: 2.5rem;
        padding-top: 0; /* Quitamos el padding superior y el borde antiguo */
        border-top: none;
        pointer-events: auto;
    }
    ...
    /* Header & Nav - Manteniendo consistencia con header.php */
    .main-header {
        position: fixed;
    }
    ...
    @media (max-width: 1024px) {
        ...
        .hero-text { max-width: 100%; background: rgba(81, 2, 0, 0.6); border-radius: 15px; padding: 1rem;}
...
<body>
    <!-- El header ya está incluido desde header.php -->
                ...
                <div class="hero-content">
                    <div class="hero-text">
                        ...
                        <div class="hero-stats">
                            ...
                            <div class="hero-stat">
                                <div class="hero-stat-number"><?php echo number_format($estadisticas['total_categorias']); ?></div>
    ...
    <script>
        ...
        (function(){
            ...
            const sim = d3.forceSimulation(data.nodes)
                ...
                .force("center", d3.forceCenter(width * 0.75, height / 1.85))
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // --- Lógica para el modal de "Inicio de Sesión Requerido" ---
            ...
            .attr("viewBox", `0 0 ${width} ${height}`)
            .attr("preserveAspectRatio", "xMidYMid slice")
            // Asegura que el fondo del SVG propio sea transparente para ver la imagen detrás
